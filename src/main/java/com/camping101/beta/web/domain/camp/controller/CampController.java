...
public class CampController {
    ...
    public Long campAdd(@RequestBody CreateCampRq rq) {

        return campService.saveCamp(rq);
    }
...
//    }
    ...
    public void campModify(@RequestBody ModifyCampRq modifyCampRq) {
    ...
    public List<FindCampIdAndNameRs> findCampList(@PathVariable("member-id") Long memberId) {
        ...
        return findCampService.findCampIdAndName(memberId);
    }
}
